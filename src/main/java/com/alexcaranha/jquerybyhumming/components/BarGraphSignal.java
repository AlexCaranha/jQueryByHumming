 ...
 */
public final class BarGraphSignal extends JPanel implements Observer{
    ...
    public BarGraphSignal(String title,
                         String titleX,
                         String titleY,
                         String alias,
                         boolean visibleLegend) {

        this(title, titleX, titleY, alias, new DefaultCategoryDataset(), visibleLegend);
    }
    ...
    private JFreeChart createChart(String title,
        ...
        JFreeChart c = ChartFactory.createBarChart(title, titleY, titleY, dataset, PlotOrientation.VERTICAL, visibleLegend, true, false);
    ...
    public void update(KeyValue[] keys) {
        for(KeyValue keyValue : keys) {
            ...
            if (key.equalsIgnoreCase("CLASS")) {
                ...
                DefaultCategoryDataset dataSet = (DefaultCategoryDataset) values[0].getValue();
