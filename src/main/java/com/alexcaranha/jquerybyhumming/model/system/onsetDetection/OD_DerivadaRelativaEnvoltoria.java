 ...
 * @author alexcaranha
 */
public class OD_DerivadaRelativaEnvoltoria extends OD {

    public OD_DerivadaRelativaEnvoltoria(int sampleRate, int frameLength, double overlap,
    ...
    public SignalXY processing(SignalXY signalXY) throws Exception {
        ...
        //----------------------------------------------------------------------
        buffer = Util.relativeDerivative(envoltorias);
        //----------------------------------------------------------------------
        if (debug) {
            Figure.save("", "tempo (s)", "Hz",
                        true,
    ...
    public String getTitle() {
        return "DERIVADA DELATIVA DA ENVOLTORIA";
    }
    ...
    public static void main(String[] args) throws Exception {
        OD od = (OD_DerivadaRelativaEnvoltoria) App.getContext().getBean("od_derivadaRelativaEnvoltoria");
        if (od != null) {
